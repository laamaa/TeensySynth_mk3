...
class AudioSynthPlaits_F32 : public AudioStream_F32
{

public:
    AudioSynthPlaits_F32() : AudioStream_F32(0, NULL)
    {
        initPlaits();
    }
    ...
    float getPatchParameter(Parameters parameter)
    {
        switch (parameter)
        {
        case engine:
    ...
    void setModulationsParameter(Parameters parameter, float value)
    {
        switch (parameter)
        {
        case note:
    ...
    float getModulationsParameter(Parameters parameter)
    {
        switch (parameter)
        {
        case note:
